package ch.aschwanden.robo.util;

import java.nio.file.Paths;

/**
 * Globale Konstanten für die MACRobo Anwendung.
 */
public class Constants {
    ...
    public static final int MAIN_WINDOW_MIN_WIDTH = 700;
    public static final int MAIN_WINDOW_MIN_HEIGHT = 450;
    public static final int SIDEBAR_WIDTH = 64;
    ...
    // Web Recording
    public static final String WEB_MACROS_FILE = Paths.get(CONFIG_DIR, "web-macros.json").toString();
    /** Pausen über diesem Schwellwert werden im Web-Recorder auf DEFAULT_STEP_DELAY_MS gekürzt (REQ-W005). */
    public static final long IDLE_THRESHOLD_MS = 2000;
    /** Standard-Verzögerung, auf die überlange Pausen gekürzt werden (REQ-W005). */
    public static final long DEFAULT_STEP_DELAY_MS = 500;

    // Capture Server
    public static final int CAPTURE_SERVER_PORT = 7890;

    // Logging
    public static final String APP_NAME = "MACRobo";
    ...
    public static final String ACCESSIBILITY_DIALOG_MSG =
        "MACRobo benötigt Zugriff auf die Barrierefreiheits-Features von macOS.\n" +
